...
public class ServerInstance implements Runnable {
    ...
    @Override
    public void run() {
        System.out.println("The server is getting ready to start ");
        ...
        try {
            latch.await();
            System.out.println( "Server has successfully started in "
 ...
 class ServerService implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println( "Service '" + serviceName + "' running ...");
        }
    }
}
